#
#  Be sure to run `pod spec lint QGGImagePicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "taizi"
  # s.authors            = { "taizi" => "changqin@ixiaopu.com" }
  # s.social_media_url   = "http://twitter.com/taizi"
